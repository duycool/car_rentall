        ...
        <tbody>
          <tr>
            ...
            <td>${custumer.phoneNumber}</td>       
             <td><a class="btn btn-primary" href="custumerIdAdmin?userid=${custumer.userid}">More</a><br>       
             	<a class="btn btn-primary" href="deleteCustumerAdmin?userid=${custumer.userid}">DELETE</a>              	
             </td>  
