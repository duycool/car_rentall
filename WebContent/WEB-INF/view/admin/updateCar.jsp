            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="${pageContext.request.contextPath}/updateCar" novalidate="novalidate" enctype="multipart/form-data">
         ...
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                   <form class="cmxform form-horizontal " id="signupForm" method="post" action="${pageContext.request.contextPath}/updateImages" novalidate="novalidate" enctype="multipart/form-data">
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3"></label>
                                        <div class="col-lg-6">
                                            <input class=" form-control"  type="hidden"   id="firstname" name="idproduct"  value="${car.id_car}">
         ...
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                   	 <form action="updateCarSpecies" method="post" style="margin-top: 100px" class="cmxform form-horizontal" id="signupForm">
         ...
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                   	 <form action="updateCarManu" method="post" style="margin-top: 100px" class="cmxform form-horizontal" id="signupForm">
        					<table border="0" width="35%" align="center">
         ...
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                   <form action="updateSeatNumber" method="post" style="margin-top: 100px" class="cmxform form-horizontal" id="signupForm">
                                	<table border="0" width="35%" align="center">
