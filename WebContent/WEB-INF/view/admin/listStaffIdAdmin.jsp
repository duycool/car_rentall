                   	 ...
                   	 <form action="" method="" style="margin-top: 100px" class="cmxform form-horizontal" id="signupForm">     			
         							<div class="form-group ">
                                        ...
                                        <div class="col-lg-6 col-sm-9">
                                        	<p class="form-control " id="firstname">${staff.fullname}</p>                                                                   
                                        </div>
                                    </div> 
         							<div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">ĐỊA CHỈ</label>
                                        <div class="col-lg-6 col-sm-9">
                                        	<p class="form-control " id="firstname">${staff.address}</p>                                                                                 
                                        </div>
                                    </div>                                                  				  
                                    <div class="form-group ">
                                        <label for="lastname" class="control-label col-lg-3">SỐ ĐIỆN THOẠI</label>
                                      	 <div class="col-lg-6 col-sm-9">
                                        	<p class="form-control " id="email">${staff.phone}</p>                                                                   
                                       	</div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="lastname" class="control-label col-lg-3">CÔNG VIỆC TRONG HỆ THỐNG</label>
                                      	 <div class="col-lg-6 col-sm-9">
                                        	<p class="form-control " id="email">${staff.works}</p>                                                                   
                                       	</div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                           	<a class="btn btn-primary" href="updateStaffAdmin?userid=${staff.userid}">CẬP NHẬT</a>
                                             	<form action="deleteStaffAdmin" method="get">
             										<input type="hidden" name="userid" value="${staff.userid}"> 
             										<input type="hidden" name="works" value="${staff.works}"> 
