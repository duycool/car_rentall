          ...
          <tr>
           <td>${car.id_car}</td>          
            ...
            <td>${car.seatnumber}</td>   
             <td>
             	<a  class="btn-primary primary" href="deleteCarManager?id_car=${car.id_car}">Delete</a> <br> 
             	<a class="btn-primary primary"  href="listCarIdManager?id_car=${car.id_car}">MORE</a>  <br>
             	<a  class="btn-primary primary"  href="addPromotionManager?id_car=${car.id_car}">AddPromotion</a> 
             </td>                  
          </tr>
        </tbody>
        </c:forEach>
