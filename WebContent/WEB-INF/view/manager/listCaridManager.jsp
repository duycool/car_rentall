                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                           	<a class="btn btn-primary" href="updateCarManager?id_car=${car.id_car}">CẬP NHẬT</a>
                                             <a class="btn btn-primary" href="deleteCarManager?id_car=${car.id_car}">XÓA</a> 
                                             <a class="btn btn-default" href="${pageContext.request.contextPath}/listCarManager">CANCEL</a>
                                        </div>
                                    </div>
   						 </form>                  
                            </div>
