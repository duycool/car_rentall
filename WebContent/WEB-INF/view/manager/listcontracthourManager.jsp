        ...
        <tbody>
          <tr>
    		...
    		<c:forEach items="${lisStaff}" var="staff"> 
     		 <a class="dropdown-item" href="${pageContext.request.contextPath}/updateContracthourManager?idcontract=${contracthour.contractid}&staff=${staff.staffid}">${staff.fullname}</a>    		
    		</c:forEach>
    		</div>    		
  			</div>  			
           	</td>             
             <td>            
             	<a href="printBillhourManager?contractid=${contracthour.contractid}">IN HÓA ĐƠN</a>
