						...
						<h5>Tên Xe : ${car.nameCar}</h5>
							...
							<div class="star-on">								
								<div class="review">														
									...
									<a href="${pageContext.request.contextPath}/login" class="add-cart item_add">Thuê Theo Ngày</a>		
									<a href="${pageContext.request.contextPath}/login" class="add-cart item_add">Thuê Theo Giờ</a>																														
							<div class="clearfix"> </div>
							</div>						
							<h5 class="item_price">	
