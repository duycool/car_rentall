         	...
         	<div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                   	 <form action="addViolateDelivery" method="post" style="margin-top: 100px" class="cmxform form-horizontal" id="signupForm">    
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                             <button class="btn btn-primary" type="submit">LƯU</button>
                                              <button class="btn btn-default" type="button" ><a href="${pageContext.request.contextPath}/homeStaffDelivery">CANCEL</a></button>
                                        </div>
                                    </div>
   						 </form>                  
                            </div>
