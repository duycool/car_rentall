		...
		<div class="account">
			<div class="account-pass">
				<div class="col-md-8 account-top">
					<a  style="color: green; text-align: center; margin-left: 200px;" href="${pageContext.request.contextPath}/historyContractDay">Lịch Sử Thuê Theo Ngày</a><br>
					<a  style="color: green; text-align: center; margin-left: 200px;" href="${pageContext.request.contextPath}/historyContractHour">Lịch Sử Thuê Theo Giờ</a>
				</div>
