...
<body>
<jsp:include page="/WEB-INF/view/templ/headeruser.jsp"></jsp:include>
<!--content-->
			...
			<div class="content-top ">
				...
				<c:forEach items="${listcar}" var="car">
					<div class="col-md-4 grid-top simpleCart_shelfItem">
						<a href="listCartid?id_car=${car.id_car}" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="images/${car.avatar}" alt="">
							<div class="b-wrapper">
					...
					<p><a  href="listCartid?id_car=${car.id_car}"><i>${product.nameCar}</i></a></p>
					</div>
					</c:forEach>
							<div class="clearfix"> </div>
				</div>
