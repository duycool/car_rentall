...
<body>
	...
	<div class="grow">
		<div class="container">
			<h2>Vui Lòng Nhập Mã Xác Nhận Thay Đổi Thông Tin</h2>
		</div>
	</div>
	<!-- grow -->
	<!--content-->
	<div class="container">
		<div class="account">
			<div class="account-pass">
				...
				<h2 align="center" style="color: green;"><%= request.getAttribute("message") != null ? request.getAttribute("message") : " " %></h2>	
					<form action="${pageContext.request.contextPath}/updateInforUserCode"
						method="post">	
						<div>
							<span>Code : </span> <input type="text" name="codeinput" />
						</div>
						<p align="center" style="color: red;"><%= request.getAttribute("result") != null ? request.getAttribute("result") : " " %></p>						
