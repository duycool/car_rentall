...
/**
 * Servlet implementation class ListCarIdhomeServlet
 */
@WebServlet(name = "listCarIdhome", urlPatterns = { "/listCarIdhome" })
public class ListCarIdhomeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListCarIdhomeServlet() {
        super();
...
//				
//				RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/view/listCarIdHome.jsp");
