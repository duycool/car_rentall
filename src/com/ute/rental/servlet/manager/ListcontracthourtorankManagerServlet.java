...
/**
 * Servlet implementation class ListcontracthourtorankManagerServlet
 */
@WebServlet(name = "listcontracthourtorankManager", urlPatterns = { "/listcontracthourtorankManager" })
public class ListcontracthourtorankManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListcontracthourtorankManagerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<ContractHour> listcontracthour = MethodDAO.listContracthouParse(contractHourDAO.getAllcontractHourTorankAdmin());
