...
/**
 * Servlet implementation class UpdateImagesManagerServlet
 */
@WebServlet(name = "updateImagesManager", urlPatterns = { "/updateImagesManager" })
@MultipartConfig(fileSizeThreshold = 1024 *1024*2,
maxFileSize = 1024 *1024*10,
maxRequestSize = 1024 *1024*50)
public class UpdateImagesManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateImagesManagerServlet() {
        super();
