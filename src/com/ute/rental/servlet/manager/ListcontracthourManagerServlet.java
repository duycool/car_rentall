...
/**
 * Servlet implementation class ListcontracthourManagerServlet
 */
@WebServlet(name = "listcontracthourManager", urlPatterns = { "/listcontracthourManager" })
public class ListcontracthourManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListcontracthourManagerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher =
				this.getServletContext().getRequestDispatcher("/WEB-INF/view/manager/listcontracthourManager.jsp");
