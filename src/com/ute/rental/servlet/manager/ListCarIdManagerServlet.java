...
/**
 * Servlet implementation class ListCarIdManagerServlet
 */
@WebServlet(name = "listCarIdManager", urlPatterns = { "/listCarIdManager" })
public class ListCarIdManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListCarIdManagerServlet() {
        super();
