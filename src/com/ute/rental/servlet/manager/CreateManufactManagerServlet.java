...
/**
 * Servlet implementation class CreateManufactManagerServlet
 */
@WebServlet(name = "createManufactManager", urlPatterns = { "/createManufactManager" })
public class CreateManufactManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateManufactManagerServlet() {
        super();
