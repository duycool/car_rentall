...
/**
 * Servlet implementation class AddViolateManagerServlet
 */
@WebServlet(name = "addViolateManager", urlPatterns = { "/addViolateManager" })
public class AddViolateManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddViolateManagerServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath() + "/listcontractViolateManager");
	}
