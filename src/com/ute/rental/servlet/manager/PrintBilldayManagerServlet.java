...
/**
 * Servlet implementation class PrintBilldayManagerServlet
 */
@WebServlet(name = "printBilldayManager", urlPatterns = { "/printBilldayManager" })
public class PrintBilldayManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrintBilldayManagerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = 
							this.getServletContext().getRequestDispatcher("/WEB-INF/view/manager/pritfBilldayManager.jsp");
