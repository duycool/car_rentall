...
/**
 * Servlet implementation class UpdateCarManagerServlet
 */
@WebServlet(name = "updateCarManager", urlPatterns = { "/updateCarManager" })
public class UpdateCarManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateCarManagerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher 
						= this.getServletContext().getRequestDispatcher("/WEB-INF/view/manager/updateCarManager.jsp");
