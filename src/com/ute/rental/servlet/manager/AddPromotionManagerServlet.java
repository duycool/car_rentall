...
/**
 * Servlet implementation class AddPromotionManagerServlet
 */
@WebServlet(name = "addPromotionManager", urlPatterns = { "/addPromotionManager" })
public class AddPromotionManagerServlet extends HttpServlet {
    ...
    public AddPromotionManagerServlet() {
        super();
