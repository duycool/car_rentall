...
/**
 * Servlet implementation class ListcontracthourOuthourDeliveryServlet
 */
@WebServlet(name = "listcontracthourOuthourDelivery", urlPatterns = { "/listcontracthourOuthourDelivery" })
public class ListcontracthourOuthourDeliveryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListcontracthourOuthourDeliveryServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<ContractHour> listcontracthour = MethodDAO.listContracthouParse(contractHourDAO.getAllcontractHourOutOfDate(idstaff));
