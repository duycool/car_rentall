...
/**
 * Servlet implementation class PrintBillhourDeliveryServlet
 */
@WebServlet(name = "printBillhourDelivery", urlPatterns = { "/printBillhourDelivery" })
public class PrintBillhourDeliveryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrintBillhourDeliveryServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = 
							this.getServletContext().getRequestDispatcher("/WEB-INF/view/delivery/pritfBillHour.jsp");
