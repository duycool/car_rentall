...
/**
 * Servlet implementation class AddViolateDeliveryServlet
 */
@WebServlet(name = "addViolateDelivery", urlPatterns = { "/addViolateDelivery" })
public class AddViolateDeliveryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddViolateDeliveryServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = 
					this.getServletContext().getRequestDispatcher("/WEB-INF/view/delivery/addViolateDelivery.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath() + "/listcontractdayOutDayDelivery");
	}
