...
/**
 * Servlet implementation class SearchCarByManuServlet
 */
@WebServlet(name = "searchCarByManu", urlPatterns = { "/searchCarByManu" })
public class SearchCarByManuServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchCarByManuServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/view/user/homeuser.jsp");
