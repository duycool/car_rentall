...
/**
 * Servlet implementation class UpdateCarSpeciesServlet
 */
@WebServlet(name = "updateCarSpecies", urlPatterns = { "/updateCarSpecies" })
public class UpdateCarSpeciesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateCarSpeciesServlet() {
        super();
