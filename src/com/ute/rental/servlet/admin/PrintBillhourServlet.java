...
/**
 * Servlet implementation class PrintBillhourServlet
 */
@WebServlet(name = "printBillhour", urlPatterns = { "/printBillhour" })
public class PrintBillhourServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrintBillhourServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = 
							this.getServletContext().getRequestDispatcher("/WEB-INF/view/admin/pritfBillHourAdmin.jsp");
