...
/**
 * Servlet implementation class ListCarOutOfStockServlet
 */
@WebServlet(name = "listCarOutOfStock", urlPatterns = { "/listCarOutOfStock" })
public class ListCarOutOfStockServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListCarOutOfStockServlet() {
        super();
