...
/**
 * Servlet implementation class UpdateCarManuServlet
 */
@WebServlet(name = "updateCarManu", urlPatterns = { "/updateCarManu" })
public class UpdateCarManuServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateCarManuServlet() {
        super();
