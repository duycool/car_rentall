...
/**
 * Servlet implementation class ListcontracthourtorankAdminServlet
 */
@WebServlet(name = "listcontracthourtorankAdmin", urlPatterns = { "/listcontracthourtorankAdmin" })
public class ListcontracthourtorankAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListcontracthourtorankAdminServlet() {
        super();
