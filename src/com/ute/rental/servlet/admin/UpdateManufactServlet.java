...
/**
 * Servlet implementation class UpdateManufactServlet
 */
@WebServlet(name = "updateManufact", urlPatterns = { "/updateManufact" })
public class UpdateManufactServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateManufactServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/view/admin/updateMunafact.jsp");
