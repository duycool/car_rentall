...
/**
 * Servlet implementation class UpdateSeatNumberServlet
 */
@WebServlet(name = "updateSeatNumber", urlPatterns = { "/updateSeatNumber" })
public class UpdateSeatNumberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateSeatNumberServlet() {
        super();
