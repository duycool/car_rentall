...
/**
 * Servlet implementation class SearchCarByPromotionhomeServlet
 */
@WebServlet(name = "searchCarByPromotionhome", urlPatterns = { "/searchCarByPromotionhome" })
public class SearchCarByPromotionhomeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchCarByPromotionhomeServlet() {
        super();
